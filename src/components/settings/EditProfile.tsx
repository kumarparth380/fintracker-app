...
export function EditProfile() {
  ...
  useEffect(() => {
    const checkProfileImage = async () => {
      try {
        const response = await fetch('/src/assets/uploads/profile.png');
        if (response.ok) {
          setProfileImage('/src/assets/uploads/profile.png');
        } else {
          setProfileImage('/src/assets/images/profile-1.jpg');
        }
      } catch (error) {
        setProfileImage('/src/assets/images/profile-1.jpg');
      }
